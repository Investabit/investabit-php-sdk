...
class PublicApi
{
    ...
    /**
     * Operation v1PublicWaitingListPost
     *
     * Waiting List
     *
     * @param  \Swagger\Client\Model\PublicWaitingListRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DefaultResponse
     */
    public function v1PublicWaitingListPost($body = null)
    {
        list($response) = $this->v1PublicWaitingListPostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation v1PublicWaitingListPostWithHttpInfo
     *
     * Waiting List
     *
     * @param  \Swagger\Client\Model\PublicWaitingListRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1PublicWaitingListPostWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\DefaultResponse';
        $request = $this->v1PublicWaitingListPostRequest($body);
    ...
    /**
     * Operation v1PublicWaitingListPostAsync
     *
     * Waiting List
     *
     * @param  \Swagger\Client\Model\PublicWaitingListRequest $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1PublicWaitingListPostAsync($body = null)
    {
        return $this->v1PublicWaitingListPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1PublicWaitingListPostAsyncWithHttpInfo
     *
     * Waiting List
     *
     * @param  \Swagger\Client\Model\PublicWaitingListRequest $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1PublicWaitingListPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\DefaultResponse';
        $request = $this->v1PublicWaitingListPostRequest($body);
    ...
    /**
     * Create request for operation 'v1PublicWaitingListPost'
     *
     * @param  \Swagger\Client\Model\PublicWaitingListRequest $body (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function v1PublicWaitingListPostRequest($body = null)
    {

        $resourcePath = '/v1/public/waiting-list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
